...
S_GUI_WINDOWS = gui/windows/project_window.c # All app window sorce files
S_GUI_TRACKSVIEW = gui/tracks_view/tracks_view.c # source files for tracks view
S_GUI = $(S_GUI_TRACKSVIEW) $(S_GUI_WINDOWS) # Gui source files
SOURCES = main.c $(S_GUI) # All source files
